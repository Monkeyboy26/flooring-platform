(() => {
  ...
  function StorefrontApp() {
    ...
    const setAccountSectionAndUrl = (section) => {
      ...
      history.pushState(
        { view: "account", accountSection: section },
        "",
    ...
    ), view === "confirmation" && /* @__PURE__ */ React.createElement(ConfirmationPage, { orderData: completedOrder, goBrowse }), view === "account" && (customer ? /* @__PURE__ */ React.createElement(
      AccountPage,
      {
        customer,
        customerToken,
        ...
        setSection: setAccountSectionAndUrl,
        wishlist,
        toggleWishlist: toggleWishlist2,
        onSkuClick: goSkuDetail,
        addToCart,
  ...
  function QuickViewModal({ sku: initialSku, onClose, addToCart, onViewDetail }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "quick-view-overlay", onClick: onClose }, /* @__PURE__ */ React.createElement("div", { className: "quick-view", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("button", { className: "quick-view-close", onClick: onClose, "aria-label": "Close" }, "\xD7"), fetchError ? /* @__PURE__ */ React.createElement("div", { className: "qv-error-state" }, /* @__PURE__ */ React.createElement("p", { className: "qv-error-text" }, "Unable to load product details."), /* @__PURE__ */ React.createElement("button", { className: "btn btn-outline", onClick: onClose }, "Close")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "quick-view-gallery" }, /* @__PURE__ */ React.createElement("div", { className: "quick-view-main-image" }, media.length > 1 && /* @__PURE__ */ React.createElement("button", { className: "quick-view-gallery-arrow left", disabled: imgIndex === 0, onClick: () => setImgIndex((i) => i - 1) }, "\u2039"), currentImg.url && /* @__PURE__ */ React.createElement("img", { onLoad: handleProductImgLoad, src: optimizeImg(currentImg.url, 800), ...optimizeSrcSet(currentImg.url, [400, 600, 800]), sizes: "(max-width: 768px) 90vw, 540px", alt: activeSku.product_name, decoding: "async", width: 540, height: 540 }), media.length > 1 && /* @__PURE__ */ React.createElement("button", { className: "quick-view-gallery-arrow right", disabled: imgIndex >= media.length - 1, onClick: () => setImgIndex((i) => i + 1) }, "\u203A"), media.length > 1 && /* @__PURE__ */ React.createElement("div", { className: "quick-view-img-counter" }, String(imgIndex + 1).padStart(2, "0"), " / ", String(media.length).padStart(2, "0"))), media.length > 1 && /* @__PURE__ */ React.createElement("div", { className: "quick-view-thumbstrip" }, media.map((m, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "quick-view-thumb" + (i === imgIndex ? " active" : ""), onClick: () => setImgIndex(i) }, m.url && /* @__PURE__ */ React.createElement("img", { onLoad: handleProductImgLoad, src: optimizeImg(m.url, 160), alt: "", decoding: "async", width: 80, height: 72 }))))), /* @__PURE__ */ React.createElement("div", { className: "quick-view-info" }, /* @__PURE__ */ React.createElement("div", { className: "qv-eyebrow" }, /* @__PURE__ */ React.createElement("span", { className: "qv-eyebrow-cat" }, catName, vendorLabel ? " \xB7 " + vendorLabel : ""), /* @__PURE__ */ React.createElement("span", { className: "qv-eyebrow-stock" }, isUnit ? "Accessory" : "Flooring")), /* @__PURE__ */ React.createElement("h2", null, fullProductName(activeSku)), activeSku.variant_name && /* @__PURE__ */ React.createElement("div", { className: "qv-variant-label" }, formatVariantName(activeSku.variant_name), activeSku.sku_code ? " \xB7 SKU " + activeSku.sku_code : ""), specItems.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "qv-specs-grid" }, specItems.slice(0, 4).map((sp, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "qv-spec-item" }, /* @__PURE__ */ React.createElement("div", { className: "qv-spec-label" }, sp.label), /* @__PURE__ */ React.createElement("div", { className: "qv-spec-value" }, sp.value)))), /* @__PURE__ */ React.createElement("div", { className: "qv-price-block" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "qv-price-amount" }, activeSku.trade_price && skuListPrice(activeSku) && /* @__PURE__ */ React.createElement("span", { className: "qv-price-original" }, "$", displayPrice(activeSku, skuListPrice(activeSku)).toFixed(2)), !activeSku.trade_price && activeSku.sale_price && skuListPrice(activeSku) && /* @__PURE__ */ React.createElement("span", { className: "qv-price-original" }, "$", displayPrice(activeSku, skuListPrice(activeSku)).toFixed(2)), "$", effectivePrice.toFixed(2), /* @__PURE__ */ React.createElement("span", { className: "qv-price-suffix" }, priceSuffix(activeSku)), !activeSku.trade_price && activeSku.sale_price && parseFloat(skuListPrice(activeSku)) > 0 && /* @__PURE__ */ React.createElement("span", { className: "qv-sale-tag" }, Math.round((1 - parseFloat(activeSku.sale_price) / parseFloat(skuListPrice(activeSku))) * 100), "% off")), activeSku.trade_price && /* @__PURE__ */ React.createElement("div", { className: "qv-price-note" }, "Trade pricing applied")), sqftBox > 0 && !isUnit && /* @__PURE__ */ React.createElement("div", { className: "qv-price-right" }, "Boxed at ", /* @__PURE__ */ React.createElement("strong", null, sqftBox.toFixed(1), " sf"), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { className: "qv-box-price" }, "$", boxPrice.toFixed(2), " / box"))), allSwatches.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "quick-view-variants-header" }, /* @__PURE__ */ React.createElement("span", null, "Colorway \xB7 ", allSwatches.length, " options"), /* @__PURE__ */ React.createElement("span", { className: "qv-current-variant" }, formatVariantName(activeSku.variant_name))), /* @__PURE__ */ React.createElement("div", { className: "quick-view-variants" }, allSwatches.map((sib) => /* @__PURE__ */ React.createElement(
      ...
      onViewDetail(activeSku.sku_id, activeSku.product_name);
      onClose();
    } }, "Order sample")), activeSku.prop65_warning && /* @__PURE__ */ React.createElement("div", { className: "prop65-warning prop65-compact" }, /* @__PURE__ */ React.createElement("span", { className: "prop65-icon", "aria-hidden": "true" }, "\u26A0"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("strong", null, "WARNING:"), " Cancer and Reproductive Harm \u2014", " ", /* @__PURE__ */ React.createElement("a", { href: "https://www.P65Warnings.ca.gov", target: "_blank", rel: "noopener noreferrer" }, "www.P65Warnings.ca.gov"))), /* @__PURE__ */ React.createElement("div", { className: "qv-footer" }, /* @__PURE__ */ React.createElement("div", { className: "qv-footer-links" }, /* @__PURE__ */ React.createElement("button", { className: "qv-footer-link", onClick: () => {
  ...
  function HomePage({ featuredSkus, featuredLoading, categories, onSkuClick, onCategorySelect, goBrowse, goTrade, goCabinets, navigate, wishlist, toggleWishlist: toggleWishlist2, setQuickViewSku, newsletterEmail, setNewsletterEmail, newsletterSubmitted, onNewsletterSubmit, onOpenQuiz }) {
    ...
    })) : /* @__PURE__ */ React.createElement("p", { className: "featured-empty" }, "Featured products coming soon."))), /* @__PURE__ */ React.createElement(RevealSection, { delay: 0.1 }, /* @__PURE__ */ React.createElement("section", { className: "form-counsel-band" }, /* @__PURE__ */ React.createElement("div", { className: "form-counsel-inner" }, /* @__PURE__ */ React.createElement("h2", { className: "form-counsel-headline" }, "Join the field guide"), /* @__PURE__ */ React.createElement("p", { className: "form-counsel-body" }, "Install math, new arrivals, showroom notes \u2014 straight to your inbox. No daily emails. Unsubscribe whenever."), newsletterSubmitted ? /* @__PURE__ */ React.createElement("p", { className: "form-counsel-success" }, "You\u2019re on the list. Watch for the next field guide.") : /* @__PURE__ */ React.createElement("form", { className: "form-counsel-form", onSubmit: onNewsletterSubmit }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "email",
    ...
    ), /* @__PURE__ */ React.createElement("button", { type: "submit", className: "form-counsel-btn form-counsel-btn-light" }, "Subscribe"))))));
  }
  ...
  function SkuDetailView({ skuId, goBack, addToCart, cart, onSkuClick, onRequestInstall, tradeCustomer, wishlist, toggleWishlist: toggleWishlist2, recentlyViewed, addRecentlyViewed, customer, customerToken, onShowAuth, showToast, categories }) {
    ...
    useEffect(() => {
      ...
      fetch(API + "/api/trade/membership", { headers: { "X-Trade-Token": t } }).then((r) => r.ok ? r.json() : null).then((d) => setTierInfo(d)).catch(() => setTierInfo(null));
    }, [tradeCustomer]);
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "pdp-section-nav", ref: navRef }, navSections.map((s) => /* @__PURE__ */ React.createElement("button", { key: s.key, "data-section": s.key, className: "pdp-section-nav-btn" + (s.key === "details" ? " active" : ""), onClick: () => scrollToSection(s.key) }, s.label))), /* @__PURE__ */ React.createElement("div", { key: sku.sku_id, className: "sku-detail" + (images.every((img) => /swatch|alternate/i.test(img.asset_type || "")) ? " sku-detail--contain" : ""), "data-sku": sku.vendor_sku || sku.internal_sku, style: loading ? { opacity: 0.6, pointerEvents: "none", transition: "opacity 0.15s ease" } : { animation: "pdpFadeIn 280ms ease-out both" } }, /* @__PURE__ */ React.createElement("button", { className: "pdp-back-btn", onClick: goBack, "aria-label": "Back" }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", style: { width: 18, height: 18 } }, /* @__PURE__ */ React.createElement("path", { d: "M19 12H5" }), /* @__PURE__ */ React.createElement("path", { d: "M12 19l-7-7 7-7" }))), /* @__PURE__ */ React.createElement("div", { className: "pdp-breadcrumbs" }, /* @__PURE__ */ React.createElement("a", { href: "#", onClick: (e) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "pdp-tier" }, /* @__PURE__ */ React.createElement("div", { className: "pdp-tier-head" }, /* @__PURE__ */ React.createElement("span", null, curName, curDisc ? " \xB7 " + curDisc + "%" : ""), /* @__PURE__ */ React.createElement("span", { className: "pdp-tier-next" }, nextTier.name, " \xB7 ", fmtPct(nextTier.discount_percent), "%")), /* @__PURE__ */ React.createElement("div", { className: "pdp-tier-track" }, /* @__PURE__ */ React.createElement("div", { className: "pdp-tier-fill", style: { width: (displayPct * 100).toFixed(1) + "%" } })), inReach ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "pdp-tier-gap" }, /* @__PURE__ */ React.createElement("strong", null, usd(amountToNext)), " more this year to unlock ", nextTier.name), saveNext > 0 && /* @__PURE__ */ React.createElement("div", { className: "pdp-tier-payoff" }, "Then this item is ", /* @__PURE__ */ React.createElement("strong", null, "$", nextTierUnitPrice.toFixed(2)), priceSuffix(sku), " ", /* @__PURE__ */ React.createElement("span", { className: "pdp-tier-save" }, "\xB7", " save $", saveNext.toFixed(2), priceSuffix(sku)))) : saveNow > 0 ? /* @__PURE__ */ React.createElement("div", { className: "pdp-tier-payoff" }, "You", "\u2019", "re saving ", /* @__PURE__ */ React.createElement("strong", null, "$", saveNow.toFixed(2)), priceSuffix(sku), " on this item as a ", curName, " member") : /* @__PURE__ */ React.createElement("div", { className: "pdp-tier-gap" }, curName, " trade pricing applied"));
    })(), (() => {
  ...
  function CheckoutPage({ cart, sessionId, goCart, handleOrderComplete, deliveryMethod, setDeliveryMethod, liftgateEnabled, tradeCustomer, tradeToken, customer, customerToken, onCustomerLogin, klarnaError, clearKlarnaError, appliedPromoCode, setAppliedPromoCode }) {
    ...
    useEffect(() => {
      ...
      fetch(API + "/api/customer/store-credit", { headers: { "X-Customer-Token": customerToken } }).then((r) => r.ok ? r.json() : { balance: 0 }).then((d) => setStoreCreditBalance(parseFloat(d.balance || 0))).catch(() => setStoreCreditBalance(0));
    }, [customerToken]);
    const creditApplicable = applyStoreCredit && storeCreditBalance > 0 ? Math.min(storeCreditBalance, cartTotal) : 0;
    const amountDue = Math.max(0, Math.round((cartTotal - creditApplicable) * 100) / 100);
    const fullyCoveredByCredit = creditApplicable >= cartTotal - 1e-3 && creditApplicable > 0;
    useEffect(() => {
      if (klarnaError) {
    ...
    const handleSubmit = async (e) => {
      ...
      setProcessing(true);
      try {
        const usingSavedCard2 = !!(customerToken && selectedSavedPm) && !fullyCoveredByCredit;
        const piBody = { session_id: sessionId, delivery_method: deliveryMethod, promo_code: appliedPromoCode || void 0 };
        if (!isPickup) {
          piBody.destination = { zip, city, state };
          piBody.residential = true;
        ...
        if (piData.fully_covered) {
          ...
          handleOrderComplete({ order: orderData2.order, sample_request: orderData2.sample_request || null });
          return;
        }
        let confirmedPiId;
        if (usingSavedCard2) {
    ...
    ))))), /* @__PURE__ */ React.createElement("div", { className: "co-schedule-note" }, "We'll confirm your appointment within 24 hours. Dates subject to availability."))), /* @__PURE__ */ React.createElement("div", { className: "co-step focus" }, /* @__PURE__ */ React.createElement("div", { className: "co-step-head" }, /* @__PURE__ */ React.createElement("div", { className: "co-step-left" }, /* @__PURE__ */ React.createElement("span", { className: "co-step-num" }, "05"), /* @__PURE__ */ React.createElement("h3", { className: "co-step-title" }, "Payment"))), customerToken && storeCreditBalance > 0 && /* @__PURE__ */ React.createElement("div", { className: "co-credit" + (applyStoreCredit ? " applied" : "") }, /* @__PURE__ */ React.createElement("div", { className: "co-credit-icon" }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5" }, /* @__PURE__ */ React.createElement("rect", { x: "2", y: "6", width: "20", height: "13", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M2 10.5h20" }), /* @__PURE__ */ React.createElement("circle", { cx: "17.5", cy: "14.5", r: "1.4", fill: "currentColor", stroke: "none" }))), /* @__PURE__ */ React.createElement("div", { className: "co-credit-body" }, /* @__PURE__ */ React.createElement("div", { className: "co-credit-title" }, "Store credit"), /* @__PURE__ */ React.createElement("div", { className: "co-credit-sub" }, "$", storeCreditBalance.toFixed(2), " available", creditApplicable > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, " \xB7 ", /* @__PURE__ */ React.createElement("span", { className: "applied-amt" }, "\u2212$", creditApplicable.toFixed(2), " applied")))), /* @__PURE__ */ React.createElement("label", { className: "co-credit-switch", "aria-label": "Apply store credit" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: applyStoreCredit, onChange: (e) => setApplyStoreCredit(e.target.checked) }), /* @__PURE__ */ React.createElement("span", { className: "co-credit-slider" }))), fullyCoveredByCredit && /* @__PURE__ */ React.createElement("div", { className: "co-final-sale", style: { background: "#f0f7ee", borderColor: "#cfe3c6" } }, "Your store credit covers this order in full \u2014 no card required."), walletAvailable && !fullyCoveredByCredit && /* @__PURE__ */ React.createElement("div", { className: "co-express-section" }, walletMode === "native" ? /* @__PURE__ */ React.createElement("div", { id: "payment-request-button" }) : /* @__PURE__ */ React.createElement("button", { type: "button", className: "co-wallet-btn", onClick: handleSimulatedWalletPay, disabled: processing }, /* @__PURE__ */ React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5" }, /* @__PURE__ */ React.createElement("rect", { x: "1", y: "4", width: "22", height: "16", rx: "2" }), /* @__PURE__ */ React.createElement("line", { x1: "1", y1: "10", x2: "23", y2: "10" })), processing ? "Processing..." : "Pay with Wallet", isLocalDev && /* @__PURE__ */ React.createElement("span", { className: "dev-badge" }, "DEV")), /* @__PURE__ */ React.createElement("div", { className: "co-divider" }, "or pay with card")), savedCards.length > 0 && !fullyCoveredByCredit && /* @__PURE__ */ React.createElement("div", { className: "co-saved-cards" }, savedCards.map((c) => /* @__PURE__ */ React.createElement("label", { key: c.id, className: "co-saved-card" + (selectedSavedPm === c.id ? " selected" : "") }, /* @__PURE__ */ React.createElement("input", { type: "radio", name: "coSavedPm", checked: selectedSavedPm === c.id, onChange: () => setSelectedSavedPm(c.id) }), /* @__PURE__ */ React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5" }, /* @__PURE__ */ React.createElement("rect", { x: "1", y: "4", width: "22", height: "16", rx: "2" }), /* @__PURE__ */ React.createElement("line", { x1: "1", y1: "10", x2: "23", y2: "10" })), /* @__PURE__ */ React.createElement("span", { className: "co-saved-card-brand" }, c.brand), /* @__PURE__ */ React.createElement("span", { className: "co-saved-card-num" }, "\u2022\u2022\u2022\u2022 ", c.last4), /* @__PURE__ */ React.createElement("span", { className: "co-saved-card-exp" }, "Exp ", String(c.exp_month).padStart(2, "0"), "/", String(c.exp_year).slice(-2)))), /* @__PURE__ */ React.createElement("label", { className: "co-saved-card" + (selectedSavedPm === null ? " selected" : "") }, /* @__PURE__ */ React.createElement("input", { type: "radio", name: "coSavedPm", checked: selectedSavedPm === null, onChange: () => setSelectedSavedPm(null) }), /* @__PURE__ */ React.createElement("span", { className: "co-saved-card-brand" }, "Use a new card"))), /* @__PURE__ */ React.createElement("div", { className: "co-card-form", style: { display: fullyCoveredByCredit || savedCards.length > 0 && selectedSavedPm ? "none" : "block" } }, /* @__PURE__ */ React.createElement("div", { className: "co-stripe-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "co-field-label" }, "Card number"), /* @__PURE__ */ React.createElement("div", { id: "card-element" })), customerToken ? /* @__PURE__ */ React.createElement("label", { className: "co-save-card" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: saveCard, onChange: (e) => setSaveCard(e.target.checked) }), " Save card for future orders") : null), !fullyCoveredByCredit && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "co-divider" }, "or"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "co-klarna-btn", onClick: handleKlarnaPay, disabled: processing }, "Pay with ", /* @__PURE__ */ React.createElement("span", { className: "co-klarna-word" }, "Klarna.")), /* @__PURE__ */ React.createElement("div", { className: "co-klarna-note" }, "Split into 4 interest-free payments. You'll finish on Klarna, then come right back."))), /* @__PURE__ */ React.createElement("div", { className: "co-step" }, /* @__PURE__ */ React.createElement("div", { className: "co-step-head" }, /* @__PURE__ */ React.createElement("div", { className: "co-step-left" }, /* @__PURE__ */ React.createElement("span", { className: "co-step-num" }, "06"), /* @__PURE__ */ React.createElement("h3", { className: "co-step-title" }, "Notes")), /* @__PURE__ */ React.createElement("div", { className: "co-step-chip" }, /* @__PURE__ */ React.createElement("span", { className: "co-step-chip-label", style: { color: "var(--warm-muted)" } }, "Optional"))), /* @__PURE__ */ React.createElement("div", { className: "co-notes" }, /* @__PURE__ */ React.createElement("textarea", { value: orderNotes, onChange: (e) => setOrderNotes(e.target.value), placeholder: "Delivery instructions, gate codes, special requests..." }), /* @__PURE__ */ React.createElement("div", { className: "co-notes-hint" }, "Visible to your project manager"))), /* @__PURE__ */ React.createElement("div", { className: "co-final-sale" }, /* @__PURE__ */ React.createElement("strong", null, "All sales are final."), " Materials cannot be returned or exchanged \u2014 please verify quantities and colors before ordering. See our", " ", /* @__PURE__ */ React.createElement("a", { href: "/returns", target: "_blank", rel: "noopener" }, "Shipping & Returns"), " policy."), /* @__PURE__ */ React.createElement("label", { className: "co-terms co-terms-check" + (termsError ? " co-terms-invalid" : "") }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: termsAccepted, onChange: (e) => setTermsAccepted(e.target.checked) }), /* @__PURE__ */ React.createElement("span", null, "I have read and agree to Roma's", " ", /* @__PURE__ */ React.createElement("a", { href: "/terms", target: "_blank", rel: "noopener" }, "terms of service"), " and", " ", /* @__PURE__ */ React.createElement("a", { href: "/privacy", target: "_blank", rel: "noopener" }, "privacy policy"), ".")), termsError && /* @__PURE__ */ React.createElement("div", { className: "co-terms-error-msg" }, "Please check the box above to place your order."), /* @__PURE__ */ React.createElement("button", { type: "submit", className: "co-place-order", disabled: processing }, processing && /* @__PURE__ */ React.createElement("span", { className: "co-spinner" }), processing ? "Processing..." : `Place Order \u2014 $${(creditApplicable > 0 ? amountDue : cartTotal).toFixed(2)}`)), /* @__PURE__ */ React.createElement("div", { className: "co-summary" }, /* @__PURE__ */ React.createElement("div", { className: "co-summary-box" }, /* @__PURE__ */ React.createElement("div", { className: "co-summary-header" }, "Order summary"), /* @__PURE__ */ React.createElement("div", { className: "co-summary-items" }, cart.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, className: "co-summary-item" }, /* @__PURE__ */ React.createElement("div", { className: "co-summary-thumb" }, item.primary_image ? /* @__PURE__ */ React.createElement("img", { src: optimizeImg(item.primary_image, 144), alt: "", decoding: "async", loading: "lazy", style: { width: "100%", height: "100%", objectFit: "cover" } }) : /* @__PURE__ */ React.createElement("div", { style: { width: "100%", height: "100%", background: "var(--stone-200)" } }), !item.is_sample && /* @__PURE__ */ React.createElement("div", { className: "co-summary-thumb-badge" }, item.num_boxes)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "co-summary-item-name" }, item.product_name || "Product"), /* @__PURE__ */ React.createElement("div", { className: "co-summary-item-detail" }, item.is_sample ? "Free sample" : item.sell_by === "unit" ? `Qty ${item.num_boxes}` : `${item.num_boxes} box${parseInt(item.num_boxes) !== 1 ? "es" : ""}`)), /* @__PURE__ */ React.createElement("div", { className: "co-summary-item-price" }, item.is_sample ? "FREE" : "$" + parseFloat(item.subtotal).toFixed(2))))), /* @__PURE__ */ React.createElement("div", { className: "co-summary-totals" }, /* @__PURE__ */ React.createElement("div", { className: "co-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Subtotal"), /* @__PURE__ */ React.createElement("span", { className: "value" }, "$", productSubtotal.toFixed(2))), promoDiscount > 0 && /* @__PURE__ */ React.createElement("div", { className: "co-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Discount", promoInfo && promoInfo.code ? " \xB7 " + promoInfo.code : ""), /* @__PURE__ */ React.createElement("span", { className: "value", style: { color: "#4a7c3e" } }, "\u2212$", promoDiscount.toFixed(2))), sampleItems.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "co-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Sample shipping"), /* @__PURE__ */ React.createElement("span", { className: "value" }, "$12.00")), taxEstimate.rate > 0 ? /* @__PURE__ */ React.createElement("div", { className: "co-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Tax (", (taxEstimate.rate * 100).toFixed(2), "%)"), /* @__PURE__ */ React.createElement("span", { className: "value" }, "$", estTax.toFixed(2))) : !isPickup && /* @__PURE__ */ React.createElement("div", { className: "co-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Tax"), /* @__PURE__ */ React.createElement("span", { className: "value", style: { color: "var(--stone-500)", fontStyle: "italic" } }, "Calculated with address")), isPickup && /* @__PURE__ */ React.createElement("div", { className: "co-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Delivery"), /* @__PURE__ */ React.createElement("span", { className: "value" }, "Pickup \u2014 Free")), creditApplicable > 0 && /* @__PURE__ */ React.createElement("div", { className: "co-summary-row" }, /* @__PURE__ */ React.createElement("span", { className: "label" }, "Store credit"), /* @__PURE__ */ React.createElement("span", { className: "value", style: { color: "#4a7c3e" } }, "\u2212$", creditApplicable.toFixed(2)))), /* @__PURE__ */ React.createElement("div", { className: "co-summary-total" }, /* @__PURE__ */ React.createElement("span", { className: "co-summary-total-label" }, creditApplicable > 0 ? "Amount due" : "Total"), /* @__PURE__ */ React.createElement("span", { className: "co-summary-total-amount" }, "$", (creditApplicable > 0 ? amountDue : cartTotal).toFixed(2)))), /* @__PURE__ */ React.createElement("a", { className: "co-summary-edit-cart", href: "#", onClick: (e) => {
      e.preventDefault();
      goCart();
  ...
  function AccountPage({ customer, customerToken, setCustomer, goBrowse, section, setSection, wishlist, toggleWishlist: toggleWishlist2, onSkuClick, addToCart, showToast, navigate, goHome, onLogout }) {
    ...
    useEffect(() => {
      fetch(API + "/api/customer/payment-methods", { headers: authHeaders }).then((r) => {
        if (!r.ok) throw new Error("HTTP " + r.status);
        return r.json();
      }).then((data) => setCards(data.cards || [])).catch(() => {
      });
      fetch(API + "/api/customer/store-credit", { headers: authHeaders }).then((r) => {
        if (!r.ok) throw new Error("HTTP " + r.status);
        return r.json();
      }).then((data) => setStoreCredit({ balance: parseFloat(data.balance || 0), entries: data.entries || [] })).catch(() => {
      });
    }, []);
    useEffect(() => {
      const ids = wishlist || [];
      ...
      fetch(API + "/api/storefront/skus?sku_ids=" + encodeURIComponent(ids.join(",")) + "&limit=" + ids.length).then((r) => {
        if (!r.ok) throw new Error("HTTP " + r.status);
        return r.json();
      }).then((data) => {
    ...
    const heroBySection = {
      ...
      wishlist: { eyebrow: (wishlist || []).length ? wishlist.length + (wishlist.length === 1 ? " material saved" : " materials saved") : "Nothing saved yet", heading: /* @__PURE__ */ React.createElement(React.Fragment, null, "Materials you're ", /* @__PURE__ */ React.createElement("em", null, "thinking about"), ".") },
      payment: { eyebrow: "Stored securely with Stripe", heading: /* @__PURE__ */ React.createElement(React.Fragment, null, "Payment ", /* @__PURE__ */ React.createElement("em", null, "methods"), ".") },
      settings: { eyebrow: "Profile & security", heading: /* @__PURE__ */ React.createElement(React.Fragment, null, "Account ", /* @__PURE__ */ React.createElement("em", null, "settings"), ".") }
    };
    const hero = heroBySection[section] || heroBySection.overview;
    const sectionHead = (eyebrow, title, action, onAction) => /* @__PURE__ */ React.createElement("div", { className: "acct-section-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-eyebrow" }, eyebrow), /* @__PURE__ */ React.createElement("h2", { className: "acct-section-title" }, title)), action && /* @__PURE__ */ React.createElement("button", { className: "acct-section-action", onClick: onAction }, action));
    const ordersTabs = [
    ...
    const renderOrderExpanded = () => /* @__PURE__ */ React.createElement("div", { className: "acct-order-expanded" }, orderDetail.order.tracking_number && /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(28,25,23,0.04)", border: "0.5px solid rgba(28,25,23,0.12)", padding: "0.75rem 1rem", marginBottom: "1rem", fontSize: "0.8125rem", color: "var(--stone-700, #44403c)", borderRadius: 4 } }, /* @__PURE__ */ React.createElement("span", { className: "acct-footer-card-sub", style: { marginRight: "0.625rem" } }, "In transit"), orderDetail.order.shipping_carrier && /* @__PURE__ */ React.createElement("span", null, orderDetail.order.shipping_carrier, " "), /* @__PURE__ */ React.createElement("strong", { style: { fontVariantNumeric: "tabular-nums" } }, orderDetail.order.tracking_number), orderDetail.order.shipped_at && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--warm-muted)", marginLeft: "0.5rem" } }, "Shipped ", fmtDate(orderDetail.order.shipped_at))), orderDetail.order.delivery_method === "pickup" && orderDetail.fulfillment_summary && orderDetail.fulfillment_summary.total > 0 && ["confirmed", "shipped", "delivered"].includes(orderDetail.order.status) && (() => {
      ...
      const stepLabels = isPickupOrder ? { pending: "Placed", confirmed: "Confirmed", ready_for_pickup: "Ready", delivered: "Picked up" } : { pending: "Placed", confirmed: "Confirmed", shipped: "Shipped", delivered: "Delivered" };
      const currentIdx = Math.max(0, steps.indexOf(orderDetail.order.status));
      return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "1.5rem" } }, /* @__PURE__ */ React.createElement("div", { className: "acct-progress" }, /* @__PURE__ */ React.createElement("div", { className: "acct-progress-fill", style: { right: 100 - (currentIdx + 1) / steps.length * 100 + "%" } })), /* @__PURE__ */ React.createElement("div", { className: "acct-progress-steps" }, steps.map((s, i) => /* @__PURE__ */ React.createElement("span", { key: s, style: { color: i <= currentIdx ? "var(--stone-800)" : "var(--warm-muted)" } }, i <= currentIdx ? "\u2713 " : "", stepLabels[s]))));
    })(), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "1rem" } }, /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card-sub", style: { marginBottom: "0.5rem" } }, "Materials"), orderDetail.items.map((item) => {
    ...
    const renderOrderRow = (order) => {
      ...
      const detailText = order.tracking_number ? (order.shipping_carrier ? order.shipping_carrier + " " : "") + order.tracking_number : order.shipped_at ? "Shipped " + fmtDate(order.shipped_at) : order.delivery_method === "pickup" ? "Showroom pickup" : "Standard delivery";
      return /* @__PURE__ */ React.createElement(React.Fragment, { key: order.id }, /* @__PURE__ */ React.createElement("div", { className: "acct-order-row", onClick: () => viewOrderDetail(order.id) }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-order-num" }, order.order_number), /* @__PURE__ */ React.createElement("div", { className: "acct-order-date" }, fmtDate(order.created_at))), /* @__PURE__ */ React.createElement("div", { className: "acct-order-items", style: { display: "flex", alignItems: "center", gap: "0.25rem", flexWrap: "wrap" } }, (order.items_preview || []).filter((p) => p.primary_image).slice(0, 5).map((p, i) => /* @__PURE__ */ React.createElement(
        "img",
        {
          key: i,
          onLoad: handleProductImgLoad,
          src: optimizeImg(p.primary_image, 100),
          alt: p.product_name || "",
          loading: "lazy",
          style: { width: 30, height: 30, objectFit: "cover", borderRadius: 3, border: "0.5px solid rgba(28,25,23,0.1)" }
        }
      )), /* @__PURE__ */ React.createElement("span", { style: { marginLeft: "0.375rem" } }, order.item_count || 0, " ", order.item_count === 1 ? "item" : "items")), /* @__PURE__ */ React.createElement("div", { className: "acct-order-detail" }, detailText, balanceDue && /* @__PURE__ */ React.createElement("span", { style: { color: "#92400e", fontWeight: 600 } }, " \xB7 Balance due")), /* @__PURE__ */ React.createElement("div", { className: "acct-order-status", style: { color: sm.color } }, "\u25CF ", sm.label), /* @__PURE__ */ React.createElement("div", { className: "acct-order-total" }, fmtMoney(order.total)), /* @__PURE__ */ React.createElement("span", { className: "acct-order-action" }, expandedOrder === order.id ? "Close \xD7" : "Open \u2192")), expandedOrder === order.id && orderDetail && orderDetail.order && renderOrderExpanded());
    };
    return /* @__PURE__ */ React.createElement("div", { className: "acct-page" }, /* @__PURE__ */ React.createElement("section", { className: "acct-hero" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: "1rem", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { className: "acct-breadcrumb" }, /* @__PURE__ */ React.createElement("a", { onClick: goHome }, "Home"), /* @__PURE__ */ React.createElement("span", { className: "acct-breadcrumb-sep" }), section === "overview" ? /* @__PURE__ */ React.createElement("span", { className: "acct-breadcrumb-current" }, "Account") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("a", { onClick: () => setSection("overview") }, "Account"), /* @__PURE__ */ React.createElement("span", { className: "acct-breadcrumb-sep" }), /* @__PURE__ */ React.createElement("span", { className: "acct-breadcrumb-current" }, (NAV_SECTIONS.find((n) => n.id === section) || {}).label || "Account"))), /* @__PURE__ */ React.createElement("div", { className: "acct-hero-meta" }, customer.email)), /* @__PURE__ */ React.createElement("div", { className: "acct-hero-grid" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-hero-eyebrow" }, hero.eyebrow), /* @__PURE__ */ React.createElement("h1", { className: "acct-hero-heading" }, hero.heading)), section === "overview" ? /* @__PURE__ */ React.createElement("div", { className: "acct-stats" }, [
    ...
    ].map((st) => /* @__PURE__ */ React.createElement("div", { key: st.l, className: "acct-stat" }, /* @__PURE__ */ React.createElement("div", { className: "acct-stat-value" }, st.v), /* @__PURE__ */ React.createElement("div", { className: "acct-stat-label" }, st.l), /* @__PURE__ */ React.createElement("div", { className: "acct-stat-sub" }, st.s)))) : section === "orders" && !loadingOrders && orders.length > 0 ? /* @__PURE__ */ React.createElement("p", { style: { fontSize: "0.9375rem", lineHeight: 1.55, color: "rgba(28,25,23,0.75)", margin: 0, maxWidth: 420, paddingBottom: "0.25rem" } }, activeOrders.length ? activeOrders.length + " in progress, " : "", orders.filter((o) => o.status === "delivered").length, " delivered", orders.filter((o) => o.status === "cancelled").length ? ", " + orders.filter((o) => o.status === "cancelled").length + " cancelled" : "", ". Filter by status below, or open any order to see materials, tracking, and documents.") : null)), /* @__PURE__ */ React.createElement("div", { className: "acct-body" }, /* @__PURE__ */ React.createElement("aside", { className: "acct-sidebar" }, /* @__PURE__ */ React.createElement("div", { className: "acct-customer-chip" }, /* @__PURE__ */ React.createElement("div", { className: "acct-avatar" }, initials), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-customer-name" }, ((customer.first_name || "") + " " + (customer.last_name || "")).trim() || customer.email), /* @__PURE__ */ React.createElement("div", { className: "acct-customer-tier" }, "\u25CF Member"))), /* @__PURE__ */ React.createElement("nav", { className: "acct-nav" }, NAV_SECTIONS.map((it) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: it.id,
        className: "acct-nav-item" + (section === it.id ? " acct-nav-item--active" : ""),
        onClick: () => setSection(it.id)
      },
      /* @__PURE__ */ React.createElement("span", { className: "acct-nav-label" }, it.label),
      /* @__PURE__ */ React.createElement("span", { className: "acct-nav-meta" }, it.meta)
    ))), /* @__PURE__ */ React.createElement("button", { className: "acct-signout", onClick: () => {
      onLogout();
      goHome();
    } }, "Sign out \u2192")), /* @__PURE__ */ React.createElement("div", { className: "acct-content" }, section === "overview" && /* @__PURE__ */ React.createElement("div", null, activeOrder && (() => {
      const o = activeOrder;
      ...
      const stepLabels = isPickup ? { pending: "Placed", confirmed: "Confirmed", ready_for_pickup: "Ready", delivered: "Picked up" } : { pending: "Placed", confirmed: "Confirmed", shipped: "Shipped", delivered: "Delivered" };
      const idx = Math.max(0, steps.indexOf(o.status));
      return /* @__PURE__ */ React.createElement("section", null, sectionHead(
        "Active right now",
        activeOrders.length === 1 ? /* @__PURE__ */ React.createElement(React.Fragment, null, "One order in ", /* @__PURE__ */ React.createElement("em", null, "flight"), ".") : /* @__PURE__ */ React.createElement(React.Fragment, null, activeOrders.length, " orders in ", /* @__PURE__ */ React.createElement("em", null, "flight"), "."),
        "Track this order \u2192",
        () => {
          setSection("orders");
          viewOrderDetail(o.id);
        }
      ), /* @__PURE__ */ React.createElement("div", { className: "acct-active-order" }, /* @__PURE__ */ React.createElement("div", { className: "acct-active-order-main" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: "1rem", fontFamily: "var(--font-body)", fontSize: "0.625rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--warm-muted)" } }, /* @__PURE__ */ React.createElement("span", null, "Order ", o.order_number), /* @__PURE__ */ React.createElement("span", { style: { color: sm.color } }, "\u25CF ", sm.label)), /* @__PURE__ */ React.createElement("h3", { style: { fontFamily: "var(--font-heading)", fontSize: "1.75rem", fontWeight: 300, letterSpacing: "-0.014em", margin: 0, color: "var(--stone-800)" } }, "Placed ", fmtDate(o.created_at), o.tracking_number ? " \xB7 on its way" : isPickup ? " \xB7 showroom pickup" : ""), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" } }, (o.items_preview || []).filter((p) => p.primary_image).slice(0, 5).map((p, i) => /* @__PURE__ */ React.createElement(
        "img",
        {
          key: i,
          onLoad: handleProductImgLoad,
          src: optimizeImg(p.primary_image, 200),
          alt: p.product_name || "",
          loading: "lazy",
          style: { width: 56, height: 56, objectFit: "cover", borderRadius: 4, border: "0.5px solid rgba(28,25,23,0.1)" }
        }
      )), /* @__PURE__ */ React.createElement("span", { style: { marginLeft: 8, fontFamily: "var(--font-heading)", fontSize: "0.9375rem", color: "rgba(28,25,23,0.7)" } }, o.item_count || 0, " ", o.item_count === 1 ? "item" : "items", " \xB7 ", fmtMoney(o.total))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-progress" }, /* @__PURE__ */ React.createElement("div", { className: "acct-progress-fill", style: { right: 100 - (idx + 1) / steps.length * 100 + "%" } })), /* @__PURE__ */ React.createElement("div", { className: "acct-progress-steps" }, steps.map((s, i) => /* @__PURE__ */ React.createElement("span", { key: s, style: { color: i <= idx ? "var(--stone-800)" : "var(--warm-muted)" } }, i <= idx ? "\u2713 " : "", stepLabels[s]))))), /* @__PURE__ */ React.createElement("div", { className: "acct-active-order-actions" }, /* @__PURE__ */ React.createElement("div", { className: "acct-eyebrow", style: { marginBottom: "0.25rem" } }, "What you can do"), /* @__PURE__ */ React.createElement("button", { className: "acct-action-link", onClick: () => {
        setSection("orders");
        viewOrderDetail(o.id);
      } }, /* @__PURE__ */ React.createElement("span", null, "Open order details"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--warm-muted)" } }, "\u2192")), o.tracking_number && /* @__PURE__ */ React.createElement(
        "a",
        {
          className: "acct-action-link",
          target: "_blank",
          rel: "noopener noreferrer",
          href: "https://www.google.com/search?q=" + encodeURIComponent(((o.shipping_carrier || "") + " " + o.tracking_number).trim())
        },
        /* @__PURE__ */ React.createElement("span", null, "Track shipment"),
        /* @__PURE__ */ React.createElement("span", { style: { color: "var(--warm-muted)" } }, "\u2192")
      ), /* @__PURE__ */ React.createElement("a", { className: "acct-action-link", href: "tel:+17149990009" }, /* @__PURE__ */ React.createElement("span", null, "Call the showroom \xB7 (714) 999-0009"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--warm-muted)" } }, "\u2192")), /* @__PURE__ */ React.createElement("button", { className: "acct-action-link", onClick: goBrowse }, /* @__PURE__ */ React.createElement("span", null, "Keep browsing materials"), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--warm-muted)" } }, "\u2192")))));
    })(), /* @__PURE__ */ React.createElement("section", null, sectionHead(
      "Order history",
      /* @__PURE__ */ React.createElement(React.Fragment, null, "Recent ", /* @__PURE__ */ React.createElement("em", null, "orders"), "."),
      orders.length > 0 ? "See all " + orders.length + " \u2192" : null,
      () => setSection("orders")
    ), loadingOrders ? /* @__PURE__ */ React.createElement("p", { style: { color: "var(--warm-muted)", fontSize: "0.875rem" } }, "Loading orders...") : orders.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "acct-profile-section", style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("p", { style: { color: "var(--warm-muted)", marginBottom: "1rem" } }, "No orders yet \u2014 your project starts with a sample."), /* @__PURE__ */ React.createElement("button", { className: "acct-btn", onClick: goBrowse }, "Start Shopping")) : /* @__PURE__ */ React.createElement("div", { className: "acct-order-table" }, orders.slice(0, 6).map(renderOrderRow))), wishlistSkus.length > 0 && /* @__PURE__ */ React.createElement("section", null, sectionHead(
      "Wishlist",
      /* @__PURE__ */ React.createElement(React.Fragment, null, wishlist.length === 1 ? "One material" : wishlist.length + " materials", " ", /* @__PURE__ */ React.createElement("em", null, "saved for later"), "."),
      "Open full wishlist \u2192",
      () => setSection("wishlist")
    ), /* @__PURE__ */ React.createElement("div", { className: "acct-wishlist-grid" }, wishlistSkus.slice(0, 4).map((sku) => /* @__PURE__ */ React.createElement("a", { key: sku.sku_id, className: "acct-wishlist-card", onClick: () => onSkuClick(sku.sku_id, sku.product_name || sku.collection) }, /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(28,25,23,0.05)", overflow: "hidden" } }, sku.primary_image && /* @__PURE__ */ React.createElement("img", { onLoad: handleProductImgLoad, src: optimizeImg(sku.primary_image, 400), alt: sku.product_name || "", loading: "lazy" })), /* @__PURE__ */ React.createElement("div", { className: "acct-wishlist-card-body" }, sku.collection && /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card-sub" }, sku.collection), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-heading)", fontSize: "1.125rem", fontWeight: 400, color: "var(--stone-800)", letterSpacing: "-0.01em" } }, fullProductName(sku)), skuListPrice(sku) && /* @__PURE__ */ React.createElement("div", { style: { marginTop: "0.25rem", fontSize: "0.875rem", fontWeight: 500, color: "var(--stone-800)" } }, "$", displayPrice(sku, skuListPrice(sku)).toFixed(2), /* @__PURE__ */ React.createElement("span", { style: { fontSize: "0.6875rem", color: "var(--warm-muted)", fontWeight: 400 } }, priceSuffix(sku)))))))), /* @__PURE__ */ React.createElement("section", { className: "acct-footer-row" }, /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card" }, /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card-head" }, /* @__PURE__ */ React.createElement("h3", { className: "acct-footer-card-title" }, "Sample boxes"), /* @__PURE__ */ React.createElement("button", { className: "acct-footer-card-action", onClick: () => setSection("samples") }, "View all")), /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card-sub" }, loadingSamples ? "Loading\u2026" : sampleRequests.length ? sampleRequests.length + (sampleRequests.length === 1 ? " box" : " boxes") + " \xB7 " + swatchCount + " swatches" : "No sample requests yet"), sampleRequests.slice(0, 3).map((sr) => {
      ...
      const quoteDetailText = (q) => {
        ...
        if (q.converted_order_id) return items + " \xB7 Became an order";
        const isExpired = q.status === "sent" && q.expires_at && new Date(q.expires_at) < /* @__PURE__ */ new Date();
        if (isExpired) return items + " \xB7 Expired " + fmtDate(q.expires_at);
        if (q.status === "sent" && q.expires_at) return items + " \xB7 Valid until " + fmtDate(q.expires_at);
        return items;
      };
      ...
      const sc = SAMPLE_STATUS_META[sr.status] || SAMPLE_STATUS_META.requested;
      const n = (sr.items || []).length;
      const detailText = isOpen ? 5 - n + " of 5 slots open \u2014 add materials" : sr.delivery_method === "pickup" && sr.status === "shipped" ? "Ready for pickup at the showroom" : sr.shipped_at ? "Shipped " + fmtDate(sr.shipped_at) : sr.delivery_method === "pickup" ? "Showroom pickup" : "Ships free";
      return /* @__PURE__ */ React.createElement(React.Fragment, { key: sr.id }, /* @__PURE__ */ React.createElement(
        "div",
        {
          className: "acct-order-row",
          style: { gridTemplateColumns: "150px 1fr 190px 110px 80px" },
          onClick: () => setExpandedSample(isExpanded ? null : sr.id)
        },
        /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-order-num" }, sr.request_number), /* @__PURE__ */ React.createElement("div", { className: "acct-order-date" }, fmtDate(sr.created_at))),
        /* @__PURE__ */ React.createElement("div", { className: "acct-order-items", style: { display: "flex", alignItems: "center", gap: "0.25rem", flexWrap: "wrap" } }, (sr.items || []).filter((i) => i.primary_image).slice(0, 5).map((i, idx) => /* @__PURE__ */ React.createElement(
          "img",
          {
            key: idx,
            onLoad: handleProductImgLoad,
            src: optimizeImg(i.primary_image, 100),
            alt: i.product_name || "",
            loading: "lazy",
            style: { width: 30, height: 30, objectFit: "cover", borderRadius: 3, border: "0.5px solid rgba(28,25,23,0.1)" }
          }
        )), /* @__PURE__ */ React.createElement("span", { style: { marginLeft: "0.375rem" } }, n, " swatch", n === 1 ? "" : "es")),
        /* @__PURE__ */ React.createElement("div", { className: "acct-order-detail" }, detailText),
        /* @__PURE__ */ React.createElement("div", { className: "acct-order-status", style: { color: sc.color } }, "\u25CF ", sc.label),
        /* @__PURE__ */ React.createElement("span", { className: "acct-order-action" }, isExpanded ? "Close \xD7" : "Open \u2192")
      ), isExpanded && /* @__PURE__ */ React.createElement("div", { className: "acct-order-expanded" }, sr.tracking_number && /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(28,25,23,0.04)", border: "0.5px solid rgba(28,25,23,0.12)", padding: "0.75rem 1rem", marginBottom: "1rem", fontSize: "0.8125rem", color: "var(--stone-700, #44403c)", borderRadius: 4 } }, /* @__PURE__ */ React.createElement("span", { className: "acct-footer-card-sub", style: { marginRight: "0.625rem" } }, "In transit"), /* @__PURE__ */ React.createElement("strong", { style: { fontVariantNumeric: "tabular-nums" } }, sr.tracking_number), sr.shipped_at && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--warm-muted)", marginLeft: "0.5rem" } }, "Shipped ", fmtDate(sr.shipped_at))), sr.delivery_method === "pickup" && sr.status === "shipped" && /* @__PURE__ */ React.createElement("div", { style: { background: "#f0fdf4", border: "0.5px solid #bbf7d0", padding: "0.75rem 1rem", marginBottom: "1rem", fontSize: "0.8125rem", color: "#166534", borderRadius: 4 } }, "Your samples are ready for pickup at our showroom."), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "1rem" } }, /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card-sub", style: { marginBottom: "0.5rem" } }, "Swatches in this box"), (sr.items || []).map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, style: { display: "flex", alignItems: "center", gap: "0.875rem", padding: "0.5rem 0", borderBottom: "0.5px solid rgba(28,25,23,0.08)", fontSize: "0.8125rem" } }, item.primary_image && /* @__PURE__ */ React.createElement("img", { onLoad: handleProductImgLoad, src: optimizeImg(item.primary_image, 100), alt: item.product_name, style: { width: 40, height: 40, objectFit: "cover", borderRadius: 4, border: "0.5px solid rgba(28,25,23,0.1)" }, loading: "lazy" }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-heading)", fontSize: "0.9375rem", color: "var(--stone-800)" } }, item.product_name), (item.collection || item.variant_name) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "0.75rem", color: "var(--warm-muted)" } }, [item.collection, item.variant_name].filter(Boolean).join(" \xB7 "))), /* @__PURE__ */ React.createElement("span", { className: "acct-order-status", style: { color: "var(--warm-muted)" } }, "Free")))), isOpen && (sr.items || []).length < 5 && /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "0.5px solid rgba(28,25,23,0.13)", borderRadius: 6, padding: "1rem 1.25rem", marginTop: "0.5rem" } }, /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card-sub", style: { marginBottom: "0.625rem" } }, "Add swatches to this box"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "text",
      ...
      ), isAdding && searchingProducts && /* @__PURE__ */ React.createElement("p", { style: { fontSize: "0.75rem", color: "var(--warm-muted)" } }, "Searching\u2026"), isAdding && sampleSearchResults.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { border: "0.5px solid rgba(28,25,23,0.13)", borderRadius: 4, maxHeight: 200, overflowY: "auto" } }, sampleSearchResults.map((sku) => {
        const alreadyAdded = (sr.items || []).some((i) => i.product_id === sku.product_id);
        return /* @__PURE__ */ React.createElement("div", { key: sku.sku_id, style: { display: "flex", alignItems: "center", gap: "0.625rem", padding: "0.5rem 0.75rem", borderBottom: "0.5px solid rgba(28,25,23,0.06)", fontSize: "0.8125rem" } }, sku.primary_image && /* @__PURE__ */ React.createElement("img", { onLoad: handleProductImgLoad, src: optimizeImg(sku.primary_image, 100), alt: "", style: { width: 32, height: 32, objectFit: "cover", borderRadius: 3 }, loading: "lazy" }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 500 } }, sku.product_name || sku.collection), sku.variant_name && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "0.75rem", color: "var(--warm-muted)" } }, sku.variant_name)), alreadyAdded ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: "0.6875rem", color: "var(--warm-muted)" } }, "Added") : /* @__PURE__ */ React.createElement(
          "button",
          {
            className: "acct-btn",
      ...
      })), /* @__PURE__ */ React.createElement("p", { style: { fontSize: "0.6875rem", color: "var(--warm-muted)", marginTop: "0.5rem", marginBottom: 0 } }, 5 - (sr.items || []).length, " more swatch", 5 - (sr.items || []).length !== 1 ? "es" : "", " can be added")), sr.delivery_method && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "0.8125rem", color: "var(--stone-600)", marginTop: "0.75rem" } }, /* @__PURE__ */ React.createElement("strong", null, "Delivery:"), " ", sr.delivery_method === "pickup" ? "Showroom pickup" : "Shipping")));
    })))), section === "visits" && (() => {
      const visitGrid = { gridTemplateColumns: "150px 1fr 130px 130px 80px" };
      return /* @__PURE__ */ React.createElement("div", null, loadingVisits ? /* @__PURE__ */ React.createElement("p", { style: { color: "var(--warm-muted)", fontSize: "0.875rem" } }, "Loading visits...") : visits.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "acct-profile-section", style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("p", { style: { color: "var(--warm-muted)", marginBottom: "0.375rem" } }, "No showroom visits yet."), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--warm-muted)", fontSize: "0.8125rem", margin: 0 } }, "Come see us at 1440 S. State College Blvd \u2014 after your visit, everything you looked at lands here with your rep's notes.")) : /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-col-headers", style: visitGrid }, /* @__PURE__ */ React.createElement("span", null, "Visit"), /* @__PURE__ */ React.createElement("span", null, "From your rep"), /* @__PURE__ */ React.createElement("span", null, "Materials"), /* @__PURE__ */ React.createElement("span", null, "Status"), /* @__PURE__ */ React.createElement("span", null)), /* @__PURE__ */ React.createElement("div", { className: "acct-order-table", style: { borderTop: "none", borderRadius: "0 0 6px 6px" } }, visits.map((v) => /* @__PURE__ */ React.createElement(React.Fragment, { key: v.id }, /* @__PURE__ */ React.createElement("div", { className: "acct-order-row", style: visitGrid, onClick: () => viewVisitDetail(v.id) }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-order-num" }, fmtDate(v.sent_at || v.created_at)), /* @__PURE__ */ React.createElement("div", { className: "acct-order-date" }, "Roma showroom \xB7 Anaheim")), /* @__PURE__ */ React.createElement("div", { className: "acct-order-detail", style: { fontStyle: v.message ? "italic" : "normal", overflow: "hidden", textOverflow: "ellipsis", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" } }, v.message ? "\u201C" + v.message + "\u201D" : "Your showroom recap"), /* @__PURE__ */ React.createElement("div", { className: "acct-order-items" }, v.item_count, " material", v.item_count !== 1 ? "s" : ""), /* @__PURE__ */ React.createElement("div", { className: "acct-order-status", style: { color: "#a87935" } }, "\u25CF Recap sent"), /* @__PURE__ */ React.createElement("span", { className: "acct-order-action" }, expandedVisit === v.id ? "Close \xD7" : "Open \u2192")), expandedVisit === v.id && visitDetail && /* @__PURE__ */ React.createElement("div", { className: "acct-order-expanded" }, v.message && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "1.25rem", padding: "0.875rem 1.125rem", background: "rgba(216,205,182,0.25)", borderLeft: "3px solid var(--gold)", fontSize: "0.875rem", color: "var(--stone-700, #44403c)", fontStyle: "italic", fontFamily: "var(--font-heading)", lineHeight: 1.55 } }, "\u201C", v.message, "\u201D"), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "0.5rem" } }, /* @__PURE__ */ React.createElement("div", { className: "acct-footer-card-sub", style: { marginBottom: "0.5rem" } }, "What you looked at"), visitDetail.items.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, style: { display: "flex", alignItems: "center", gap: "0.875rem", padding: "0.625rem 0", borderBottom: "0.5px solid rgba(28,25,23,0.08)", fontSize: "0.8125rem" } }, item.primary_image && /* @__PURE__ */ React.createElement(
        "img",
        {
          onLoad: handleProductImgLoad,
          src: optimizeImg(item.primary_image, 100),
        ...
        "div",
        {
          style: { fontFamily: "var(--font-heading)", fontSize: "0.9375rem", color: "var(--stone-800)", cursor: item.sku_id ? "pointer" : "default" },
          onClick: () => item.sku_id && onSkuClick(item.sku_id, item.product_name)
        },
        item.product_name
      ), (item.collection || item.variant_name) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "0.75rem", color: "var(--warm-muted)" } }, [item.collection, item.variant_name].filter(Boolean).join(" \xB7 ")), item.rep_note && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "0.75rem", color: "#7a5a1e", fontStyle: "italic", marginTop: 2 } }, item.rep_note)), skuListPrice(item) && /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 500, whiteSpace: "nowrap", fontVariantNumeric: "tabular-nums" } }, "$", displayPrice(item, skuListPrice(item)).toFixed(2), priceSuffix(item))))), v.token && navigate && /* @__PURE__ */ React.createElement("button", { className: "acct-btn acct-btn--outline", style: { marginTop: "0.75rem" }, onClick: () => navigate("/visit/" + v.token) }, "Open the full recap page \u2192")))))));
    })(), section === "settings" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-profile-section" }, /* @__PURE__ */ React.createElement("h3", { className: "acct-profile-title" }, "Profile & address"), profileMsg && /* @__PURE__ */ React.createElement("div", { className: "acct-msg--success" }, profileMsg), profileError && /* @__PURE__ */ React.createElement("div", { className: "acct-msg--error" }, profileError), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" } }, /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "First Name"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, value: firstName, onChange: (e) => setFirstName(e.target.value) })), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Last Name"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, value: lastName, onChange: (e) => setLastName(e.target.value) }))), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Email"), /* @__PURE__ */ React.createElement("input", { style: { ...inputStyle, background: "var(--stone-100)", color: "var(--stone-500)" }, value: customer.email, readOnly: true })), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Phone"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, type: "tel", value: phone, onChange: (e) => setPhone(formatPhone(e.target.value)), placeholder: "(555) 123-4567" })), /* @__PURE__ */ React.createElement("h3", { style: { fontSize: "1rem", fontWeight: 500, marginTop: "1.5rem", marginBottom: "1rem" } }, "Saved Address"), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Address Line 1"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, value: addressLine1, onChange: (e) => setAddressLine1(e.target.value), placeholder: "123 Main Street" })), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Address Line 2"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, value: addressLine2, onChange: (e) => setAddressLine2(e.target.value), placeholder: "Apt, Suite, Unit" })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "0.75rem" } }, /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "City"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, value: city, onChange: (e) => setCity(e.target.value) })), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "State"), /* @__PURE__ */ React.createElement("select", { style: { ...inputStyle, padding: "0.65rem 0.5rem" }, value: addrState, onChange: (e) => setAddrState(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "Select"), US_STATES.map((s) => /* @__PURE__ */ React.createElement("option", { key: s, value: s }, s)))), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "ZIP"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, value: zip, onChange: (e) => setZip(e.target.value) }))), /* @__PURE__ */ React.createElement("button", { className: "acct-btn", onClick: saveProfile, disabled: saving }, saving ? "Saving..." : "Save Changes")), /* @__PURE__ */ React.createElement("div", { className: "acct-profile-section" }, /* @__PURE__ */ React.createElement("h3", { className: "acct-profile-title" }, "Change password"), pwMsg && /* @__PURE__ */ React.createElement("div", { className: "acct-msg--success" }, pwMsg), pwError && /* @__PURE__ */ React.createElement("div", { className: "acct-msg--error" }, pwError), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Current Password"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, type: "password", value: currentPw, onChange: (e) => setCurrentPw(e.target.value) })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" } }, /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "New Password"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, type: "password", value: newPw, onChange: (e) => setNewPw(e.target.value) })), /* @__PURE__ */ React.createElement("div", { style: fieldStyle }, /* @__PURE__ */ React.createElement("label", { style: labelStyle }, "Confirm New Password"), /* @__PURE__ */ React.createElement("input", { style: inputStyle, type: "password", value: confirmPw, onChange: (e) => setConfirmPw(e.target.value) }))), /* @__PURE__ */ React.createElement("p", { style: { fontSize: "0.75rem", color: "var(--stone-500)", marginBottom: "1rem" } }, "8+ characters, 1 uppercase letter, 1 number"), /* @__PURE__ */ React.createElement("button", { className: "acct-btn", onClick: changePassword, disabled: pwSaving }, pwSaving ? "Updating..." : "Update Password"))), section === "wishlist" && (() => {
      ...
      const coverageMeta = (sku) => {
        ...
        if (spb > 0) return "Box covers " + spb.toFixed(1).replace(/\.0$/, "") + " ft\xB2";
        return null;
      };
      return /* @__PURE__ */ React.createElement("div", null, (wishlist || []).length === 0 ? /* @__PURE__ */ React.createElement("section", { style: { textAlign: "center", padding: "4rem 1rem" } }, /* @__PURE__ */ React.createElement("h3", { style: { fontFamily: "var(--font-heading)", fontSize: "1.5rem", fontWeight: 300, marginBottom: "0.5rem" } }, "Nothing saved yet."), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--stone-600)", marginBottom: "1.5rem" } }, "Save anything you're considering by tapping the heart while you browse \u2014 it'll wait for you here."), /* @__PURE__ */ React.createElement("button", { className: "acct-btn", onClick: goBrowse }, "Browse materials")) : /* @__PURE__ */ React.createElement("div", null, sectionHead(
        "Saved materials",
        /* @__PURE__ */ React.createElement(React.Fragment, null, "Order samples, or open any material to ", /* @__PURE__ */ React.createElement("em", null, "buy it"), "."),
        wlSelected.length ? null : "Order samples of everything \u2192",
        wlSelected.length ? null : () => orderSamples(wishlistSkus)
      ), wlSelected.length > 0 && /* @__PURE__ */ React.createElement("div", { style: {
        background: "var(--warm-bg, #f5f0e8)",
    ...
    })(), section === "payment" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-profile-section" }, /* @__PURE__ */ React.createElement("h3", { className: "acct-profile-title" }, "Payment methods"), /* @__PURE__ */ React.createElement(PaymentMethodsSection, { customerToken, customer, onCardsChange: setCards })), /* @__PURE__ */ React.createElement("div", { className: "acct-profile-section" }, /* @__PURE__ */ React.createElement("h3", { className: "acct-profile-title" }, "Store credit"), /* @__PURE__ */ React.createElement("div", { className: "acct-credit-hero" }, /* @__PURE__ */ React.createElement("p", { className: "acct-credit-eyebrow" }, "Available balance"), /* @__PURE__ */ React.createElement("div", { className: "acct-credit-balance" }, "$", Math.floor(storeCredit.balance), /* @__PURE__ */ React.createElement("span", { className: "cents" }, ".", Math.round((storeCredit.balance - Math.floor(storeCredit.balance)) * 100).toString().padStart(2, "0"))), /* @__PURE__ */ React.createElement("p", { className: "acct-credit-caption" }, storeCredit.balance > 0 ? "Applied automatically at checkout to reduce your card charge." : "Credit from returns or refunds will appear here.")), storeCredit.entries.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "acct-credit-history-label" }, "Recent activity"), storeCredit.entries.slice(0, 8).map((e, i) => {
      const amt = parseFloat(e.amount || 0);
      const d = e.created_at ? new Date(e.created_at).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) : "";
      return /* @__PURE__ */ React.createElement("div", { key: i, className: "acct-credit-row" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "acct-credit-reason" }, e.reason || (amt < 0 ? "Applied to order" : "Credit"), e.order_number ? " \xB7 " + e.order_number : ""), d && /* @__PURE__ */ React.createElement("div", { className: "acct-credit-date" }, d)), /* @__PURE__ */ React.createElement("div", { className: "acct-credit-amt " + (amt < 0 ? "neg" : "pos") }, amt < 0 ? "\u2212$" + Math.abs(amt).toFixed(2) : "+$" + amt.toFixed(2)));
    })))))));
  }
  ...
  function TapSelect({ theme, label, value, onChange, onBlur, required, error, children }) {
    const { ink, accent, muted } = theme;
    return /* @__PURE__ */ React.createElement("label", { style: { display: "grid", gap: 7 } }, /* @__PURE__ */ React.createElement(TapMicro, { theme }, label, required && /* @__PURE__ */ React.createElement("span", { style: { color: accent } }, " *")), /* @__PURE__ */ React.createElement("select", { value, onChange, onBlur, style: { border: "none", borderBottom: `0.5px solid ${error ? "#c0392b" : ink + "33"}`, background: "transparent", padding: "7px 0", font: "400 16px/1.35 var(--roma-serif)", color: value ? ink : `${ink}55`, outline: "none", borderRadius: 0, width: "100%", boxSizing: "border-box", cursor: "pointer" } }, children), error && /* @__PURE__ */ React.createElement("div", { style: { font: "400 11px/1.4 var(--roma-sans)", color: "#c0392b" } }, error));
  }
  ...
  function TapDropzone({ theme, label, docType, upload, uploading, onFile, onRemove }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 20px", border: `0.5px ${done ? "solid" : "dashed"} ${done ? success : ink + "44"}`, background: done ? "#3f7a520d" : "transparent", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 14 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 26, height: 26, borderRadius: "50%", flex: "none", display: "flex", alignItems: "center", justifyContent: "center", border: `1px solid ${done ? success : busy ? ink + "55" : ink + "33"}`, background: done ? success : "transparent", color: done ? "#fff" : muted, font: "600 13px/1 var(--roma-sans)" } }, busy ? "\u2026" : done ? "\u2713" : "+"), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { font: "400 14px/1.3 var(--roma-sans)", color: ink } }, label), /* @__PURE__ */ React.createElement(TapMicro, { theme, color: done ? success : muted, style: { marginTop: 4, textTransform: "none", letterSpacing: "0.04em", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: 320 } }, busy ? "Uploading\u2026" : done ? `Uploaded \xB7 ${upload.file_name}` : "PDF or photo \xB7 10 MB max"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center", flex: "none" } }, done && onRemove && /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => onRemove(docType), style: { background: "none", border: "none", cursor: "pointer", color: muted, font: "500 11px/1 var(--roma-sans)", letterSpacing: "0.1em", textTransform: "uppercase", padding: 0 } }, "Remove"), /* @__PURE__ */ React.createElement("label", { style: { padding: "10px 18px", border: `0.5px solid ${ink}66`, font: "500 11px/1 var(--roma-sans)", letterSpacing: "0.1em", textTransform: "uppercase", color: ink, cursor: "pointer", whiteSpace: "nowrap" } }, done ? "Replace" : "Browse", /* @__PURE__ */ React.createElement("input", { type: "file", accept: "image/*,application/pdf", style: { display: "none" }, onChange: (e) => {
  ...
  function TradeApplyPage({ goHome, goTrade, onLogin }) {
    ...
    const removeDoc = (docType) => setDocUploads((prev) => {
      const n = { ...prev };
      delete n[docType];
      return n;
    });
    const handleDocUpload = async (docType, file) => {
      if (file.size > 10 * 1024 * 1024) {
        setError("That file is over 10 MB \u2014 please upload a smaller PDF or photo.");
        return;
      }
      setUploading(docType);
      setError("");
    ...
    const handleSubmit = async () => {
      ...
      if (!einValid) {
        setError("Please enter a valid 9-digit EIN (XX-XXXXXXX).");
        return;
      }
      if (!stateValid) {
        setError("Please enter a 2-letter state code.");
        return;
      }
      if (!zipValid) {
        setError("Please enter a valid ZIP code.");
      ...
      if (!docUploads.business_card) {
        setError("A photo of your business card is required.");
        return;
      }
      setLoading(true);
      try {
        ...
        const resp = await fetch(API + "/api/trade/register/enhanced", {
          ...
          body: JSON.stringify({
            ...
            zip,
            ein: ein.trim() || null,
            contractor_license: contractorLicense.trim() || null,
            document_ids: docIds
          })
        });
        const data = await resp.json();
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "tv2-page", style: { background: paper, color: ink, fontFamily: "var(--roma-sans)" } }, /* @__PURE__ */ React.createElement("section", { style: { padding: "40px 80px 48px", borderBottom: `0.5px solid ${ink}18` } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 30, flexWrap: "wrap", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { font: "500 11px/1 ui-monospace, monospace", letterSpacing: "0.18em", textTransform: "uppercase", color: muted, display: "flex", gap: 14, alignItems: "center" } }, /* @__PURE__ */ React.createElement("a", { onClick: goHome, style: { color: muted, textDecoration: "none", cursor: "pointer" } }, "Home"), /* @__PURE__ */ React.createElement("span", { style: { width: 14, height: 1, background: `${ink}33` } }), /* @__PURE__ */ React.createElement("a", { onClick: goTrade, style: { color: muted, textDecoration: "none", cursor: "pointer" } }, "Trade"), /* @__PURE__ */ React.createElement("span", { style: { width: 14, height: 1, background: `${ink}33` } }), /* @__PURE__ */ React.createElement("span", { style: { color: ink } }, "Apply")), /* @__PURE__ */ React.createElement("a", { onClick: onLogin, style: { font: "500 11px/1 ui-monospace, monospace", letterSpacing: "0.16em", textTransform: "uppercase", color: ink, cursor: "pointer", textDecoration: "none" } }, "Already a Roma pro? Sign in \u2192")), /* @__PURE__ */ React.createElement("div", { "data-tv2-2col": true, style: { display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 80, alignItems: "end" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(TapMicro, { theme, color: accent, style: { marginBottom: 18, letterSpacing: "0.2em", fontSize: 11 } }, "\u25CF Trade application \xB7 a few minutes"), /* @__PURE__ */ React.createElement("h1", { style: { font: "300 clamp(44px, 6vw, 84px)/0.95 var(--roma-serif)", letterSpacing: "-0.022em", margin: 0, color: ink } }, "A short form between you and ", /* @__PURE__ */ React.createElement("em", { style: { color: accent } }, "trade pricing"), ".")), /* @__PURE__ */ React.createElement("p", { style: { font: "400 16px/1.6 var(--roma-sans)", color: `${ink}b3`, margin: "0 0 8px", maxWidth: 420 } }, "Every application is read by a Roma rep, not a robot. Two business days in most cases \u2014 four hours if you carry a CSLB number."))), /* @__PURE__ */ React.createElement("section", { "data-tv2-2col": true, style: { padding: "64px 80px", display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 80, alignItems: "start" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 24 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(TapMicro, { theme, color: accent, style: { marginBottom: 12 } }, "Before you start"), /* @__PURE__ */ React.createElement("h2", { style: { font: "300 40px/1.05 var(--roma-serif)", letterSpacing: "-0.016em", margin: 0, color: ink } }, "Have these ", /* @__PURE__ */ React.createElement("em", { style: { color: accent } }, "three"), " ready.")), [
      ["01 \xB7 Business card", "A clear photo of your business card \u2014 required. It\u2019s the fastest way for a rep to confirm who you are."],
      ["02 \xB7 EIN & license #", "Your federal EIN, plus a contractor or credential number (CSLB, ASID, IIDA\u2026) if you carry one."],
      ["03 \xB7 Resale certificate", "Optional \u2014 your CDTFA seller\u2019s permit sets up tax-free buying on materials you resell."]
    ].map(([t, b]) => /* @__PURE__ */ React.createElement("div", { key: t, style: { padding: "18px 22px", background: warm, border: `0.5px solid ${ink}18` } }, /* @__PURE__ */ React.createElement(TapMicro, { theme, color: ink, style: { marginBottom: 8 } }, t), /* @__PURE__ */ React.createElement("div", { style: { font: "400 13px/1.55 var(--roma-sans)", color: `${ink}b3` } }, b))), /* @__PURE__ */ React.createElement("div", { style: { padding: "18px 22px", border: `0.5px solid ${accent}55` } }, /* @__PURE__ */ React.createElement(TapMicro, { theme, color: accent, style: { marginBottom: 8 } }, "What you get on approval"), /* @__PURE__ */ React.createElement("div", { style: { font: "400 13px/1.6 var(--roma-sans)", color: ink } }, "Your tier (starts at 10% off list, contracted), your dedicated rep\u2019s direct line, and your trade dashboard for orders, quotes, and projects.")), /* @__PURE__ */ React.createElement(TapMicro, { theme }, "Questions? Call (714) 999-0009")), submitted ? /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: `0.5px solid ${ink}22`, padding: "48px 44px", display: "grid", gap: 18 } }, /* @__PURE__ */ React.createElement(TapMicro, { theme, color: accent }, "\u25CF Application received"), /* @__PURE__ */ React.createElement("h2", { style: { font: "300 44px/1.05 var(--roma-serif)", letterSpacing: "-0.016em", margin: 0, color: ink } }, "Thanks \u2014 it\u2019s with a rep now."), /* @__PURE__ */ React.createElement("p", { style: { font: "400 15px/1.6 var(--roma-sans)", color: `${ink}b3`, margin: 0, maxWidth: 520 } }, "Your trade application is under review. We\u2019ll email ", /* @__PURE__ */ React.createElement("strong", { style: { color: ink } }, email), " once it\u2019s approved \u2014 usually within two business days, and often sooner with a CSLB number."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, marginTop: 6, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("a", { onClick: goHome, style: { padding: "14px 26px", background: ink, color: paper, textDecoration: "none", cursor: "pointer", textTransform: "uppercase", letterSpacing: "0.1em", font: "500 12px/1 var(--roma-sans)" } }, "Back to home \u2192"), /* @__PURE__ */ React.createElement("a", { onClick: onLogin, style: { padding: "14px 0 6px", color: ink, cursor: "pointer", textDecoration: "none", borderBottom: `1px solid ${ink}`, textTransform: "uppercase", letterSpacing: "0.1em", font: "500 12px/1 var(--roma-sans)" } }, "Trade sign in \u2192"))) : /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: `0.5px solid ${ink}22`, padding: "40px 44px" } }, error && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 24, padding: "12px 16px", background: "#c0392b12", border: "0.5px solid #c0392b55", font: "400 13px/1.5 var(--roma-sans)", color: "#8a2a1e" } }, error), /* @__PURE__ */ React.createElement(TapSection, { theme, num: "01", title: "About you" }, /* @__PURE__ */ React.createElement(TapRow, null, /* @__PURE__ */ React.createElement(TapInput, { theme, label: "First name", required: true, value: firstName, onChange: (e) => setFirstName(e.target.value), onBlur: () => touch("firstName"), error: reqErr("firstName", firstName), autoComplete: "given-name" }), /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Last name", required: true, value: lastName, onChange: (e) => setLastName(e.target.value), onBlur: () => touch("lastName"), error: reqErr("lastName", lastName), autoComplete: "family-name" })), /* @__PURE__ */ React.createElement(TapRow, null, /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Business email", required: true, mono: true, value: email, onChange: (e) => setEmail(e.target.value), onBlur: () => touch("email"), valid: emailValid, error: touched.email && !!email && !emailValid ? "Enter a valid email address" : reqErr("email", email), autoComplete: "email", placeholder: "you@studio.com" }), /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Phone", required: true, mono: true, value: phone, onChange: (e) => setPhone(formatPhone(e.target.value)), onBlur: () => touch("phone"), valid: phoneValid, error: touched.phone && !!phone && !phoneValid ? "Enter a 10-digit phone number" : reqErr("phone", phone), autoComplete: "tel", placeholder: "(949) 555-0148" })), /* @__PURE__ */ React.createElement(TapRow, null, /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Password", required: true, type: "password", mono: true, value: password, onChange: (e) => setPassword(e.target.value), onBlur: () => touch("password"), valid: passwordValid, error: touched.password && !!password && !passwordValid ? "At least 8 characters, one capital, one number" : reqErr("password", password), hint: !password ? "8+ characters, one capital, one number" : "", autoComplete: "new-password", placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" }), /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Confirm password", required: true, type: "password", mono: true, value: confirmPassword, onChange: (e) => setConfirmPassword(e.target.value), onBlur: () => touch("confirmPassword"), valid: !!confirmPassword && confirmPassword === password, error: touched.confirmPassword && !!confirmPassword && confirmPassword !== password ? "Passwords don\u2019t match" : reqErr("confirmPassword", confirmPassword), autoComplete: "new-password", placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022" }))), /* @__PURE__ */ React.createElement(TapSection, { theme, num: "02", title: "Your business", sub: "This is what your rep verifies \u2014 the closer it matches your paperwork, the faster the approval." }, /* @__PURE__ */ React.createElement(TapRow, { cols: "1.5fr 1fr" }, /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Firm name", required: true, value: companyName, onChange: (e) => setCompanyName(e.target.value), onBlur: () => touch("companyName"), error: reqErr("companyName", companyName), autoComplete: "organization" }), /* @__PURE__ */ React.createElement(TapSelect, { theme, label: "Trade type", required: true, value: businessType, onChange: (e) => setBusinessType(e.target.value), onBlur: () => touch("businessType"), error: reqErr("businessType", businessType) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "Select\u2026"), /* @__PURE__ */ React.createElement("option", { value: "contractor" }, "General contractor"), /* @__PURE__ */ React.createElement("option", { value: "interior_designer" }, "Interior designer"), /* @__PURE__ */ React.createElement("option", { value: "architect" }, "Architect"), /* @__PURE__ */ React.createElement("option", { value: "builder" }, "Builder / developer"), /* @__PURE__ */ React.createElement("option", { value: "retailer" }, "Flooring retailer"), /* @__PURE__ */ React.createElement("option", { value: "other" }, "Other"))), /* @__PURE__ */ React.createElement(TapRow, null, /* @__PURE__ */ React.createElement(TapInput, { theme, label: "EIN (federal tax ID)", required: true, mono: true, value: ein, onChange: (e) => setEin(formatEin(e.target.value)), onBlur: () => touch("ein"), valid: einValid, error: touched.ein && !!ein && !einValid ? "An EIN is 9 digits (XX-XXXXXXX)" : reqErr("ein", ein), placeholder: "12-3456789" }), /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Contractor license # (optional)", mono: true, value: contractorLicense, onChange: (e) => setContractorLicense(e.target.value), placeholder: "CSLB # \u2014 clears fastest" })), /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Street address", required: true, value: addressLine1, onChange: (e) => setAddressLine1(e.target.value), onBlur: () => touch("addressLine1"), error: reqErr("addressLine1", addressLine1), autoComplete: "address-line1" }), /* @__PURE__ */ React.createElement(TapRow, { cols: "2fr 1fr 1fr" }, /* @__PURE__ */ React.createElement(TapInput, { theme, label: "City", required: true, value: city, onChange: (e) => setCity(e.target.value), onBlur: () => touch("city"), error: reqErr("city", city), autoComplete: "address-level2" }), /* @__PURE__ */ React.createElement(TapInput, { theme, label: "State", required: true, value: addrState, onChange: (e) => setAddrState(e.target.value.replace(/[^a-zA-Z]/g, "").toUpperCase()), onBlur: () => touch("state"), valid: stateValid, error: touched.state && !!addrState && !stateValid ? "2-letter code" : reqErr("state", addrState), maxLength: 2, autoComplete: "address-level1", placeholder: "CA" }), /* @__PURE__ */ React.createElement(TapInput, { theme, label: "Zip", required: true, mono: true, value: zip, onChange: (e) => setZip(e.target.value.replace(/[^\d-]/g, "").slice(0, 10)), onBlur: () => touch("zip"), valid: zipValid, error: touched.zip && !!zip && !zipValid ? "5-digit ZIP" : reqErr("zip", zip), maxLength: 10, autoComplete: "postal-code", placeholder: "92806" }))), /* @__PURE__ */ React.createElement(TapSection, { theme, num: "03", title: "Verification", sub: "A photo of your business card is required; the rest are optional and just speed up review. Upload a PDF or a clear photo." }, /* @__PURE__ */ React.createElement(TapDropzone, { theme, label: "Business card \xB7 photo \xB7 required", docType: "business_card", upload: docUploads.business_card, uploading, onFile: handleDocUpload, onRemove: removeDoc }), /* @__PURE__ */ React.createElement(TapDropzone, { theme, label: "Resale certificate (CDTFA) \xB7 optional", docType: "resale_cert", upload: docUploads.resale_cert, uploading, onFile: handleDocUpload, onRemove: removeDoc }), /* @__PURE__ */ React.createElement(TapDropzone, { theme, label: "Contractor license \xB7 optional", docType: "contractor_license", upload: docUploads.contractor_license, uploading, onFile: handleDocUpload, onRemove: removeDoc })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", alignItems: "center", gap: 24 } }, /* @__PURE__ */ React.createElement("button", { onClick: handleSubmit, disabled: loading, style: { padding: "16px 32px", background: ink, color: paper, border: "none", font: "500 12px/1 var(--roma-sans)", letterSpacing: "0.1em", textTransform: "uppercase", cursor: loading ? "default" : "pointer", opacity: loading ? 0.6 : 1 } }, loading ? "Submitting\u2026" : "Submit application \u2192")), /* @__PURE__ */ React.createElement(TapMicro, { theme, style: { marginTop: 14, textAlign: "right" } }, "Reviewed by a human \xB7 no credit pull \xB7 nothing is charged"))), /* @__PURE__ */ React.createElement("section", { style: { padding: "0 80px 100px" } }, /* @__PURE__ */ React.createElement("div", { "data-tv2-2col": true, style: { borderTop: `0.5px solid ${ink}22`, paddingTop: 48, display: "grid", gridTemplateColumns: "1fr 2fr", gap: 60 } }, /* @__PURE__ */ React.createElement("h2", { style: { font: "300 44px/1.05 var(--roma-serif)", letterSpacing: "-0.016em", margin: 0, color: ink } }, "What happens ", /* @__PURE__ */ React.createElement("em", { style: { color: accent } }, "after"), " you submit."), /* @__PURE__ */ React.createElement("div", { "data-tv2-grid": true, style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 } }, afterSteps.map((s, i) => /* @__PURE__ */ React.createElement("div", { key: s.t, style: { padding: "24px 24px", background: i === 2 ? warm : "transparent", border: `0.5px solid ${ink}22`, display: "grid", gap: 10, alignContent: "start" } }, /* @__PURE__ */ React.createElement(TapMicro, { theme, color: accent }, s.t), /* @__PURE__ */ React.createElement("div", { style: { font: "400 14px/1.55 var(--roma-sans)", color: `${ink}cc` } }, s.b)))))));
  }
  ...
  function LegalPage({ kind, goHome, navigate }) {
    ...
    const privacySections = [
      ...
      { h: "7. Cookies & Your Choices", p: "When you first visit, a cookie notice lets you accept or decline non-essential cookies, and you can change your choice at any time using the \u201CCookie preferences\u201D link in the site footer; if you decline, we do not collect analytics about your visit. Most browsers also let you refuse or delete cookies through their settings; note that disabling cookies may affect cart, checkout, and other features. Some browsers offer a \u201CDo Not Track\u201D (DNT) signal \u2014 because no common industry standard for responding to DNT has been adopted, this site does not respond to DNT signals, though our cookie notice gives you an equivalent choice about non-essential tracking. You may unsubscribe from marketing emails using the link in those messages or by contacting us; we may still send you non-promotional, transactional messages about your orders and account." },
  ...
  function SiteFooter({ goHome, goBrowse, goCollections, goTrade, onInstallClick, navigate }) {
    return /* @__PURE__ */ React.createElement("div", { className: "footer" }, /* @__PURE__ */ React.createElement("div", { className: "footer-inner" }, /* @__PURE__ */ React.createElement("div", { className: "footer-brand" }, /* @__PURE__ */ React.createElement("h3", null, "Roma Flooring Designs"), /* @__PURE__ */ React.createElement("p", null, "Premium flooring, tile, stone, and countertop products. Curated collections for designers, builders, and homeowners since 2010.")), /* @__PURE__ */ React.createElement("div", { className: "footer-col" }, /* @__PURE__ */ React.createElement("h4", null, "Shop"), /* @__PURE__ */ React.createElement("a", { href: "#", onClick: (e) => {
      ...
      e.preventDefault();
      navigate("/terms");
    } }, "Terms"), /* @__PURE__ */ React.createElement("span", null, "|"), /* @__PURE__ */ React.createElement("a", { href: "/returns", onClick: (e) => {
      e.preventDefault();
      navigate("/returns");
    } }, "Shipping & Returns"), /* @__PURE__ */ React.createElement("span", null, "|"), /* @__PURE__ */ React.createElement("a", { href: "#", onClick: (e) => {
      e.preventDefault();
      try {
