...
function StorefrontApp() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    setAuthModalMode("login");
    setShowAuthModal(true);
  } }, "Sign In"))), view === "wishlist" && /* @__PURE__ */ React.createElement(WishlistPage, { wishlist, toggleWishlist, onSkuClick: goSkuDetail, goBrowse }), view === "collections" && /* @__PURE__ */ React.createElement(CollectionsPage, { onCollectionClick: handleCollectionClick }), view === "trade" && /* @__PURE__ */ React.createElement(TradePage, { goTradeDashboard, onApplyClick: () => {
    setTradeModalMode("register");
    setShowTradeModal(true);
  }, tradeCustomer }), view === "trade-dashboard" && (tradeCustomer ? /* @__PURE__ */ React.createElement(TradeDashboard, { tradeCustomer, tradeToken, addToCart, goBrowse, setTradeCustomer, handleTradeLogout, goBulkOrder }) : /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 600, margin: "4rem auto", textAlign: "center", padding: "0 2rem" } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--font-heading)", fontWeight: 300, marginBottom: "1rem" } }, "Trade Login Required"), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--stone-600)", marginBottom: "1.5rem" } }, "Please sign in with your trade account to access the dashboard."), /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: () => {
    setTradeModalMode("login");
    setShowTradeModal(true);
  } }, "Trade Sign In"))), view === "bulk-order" && /* @__PURE__ */ React.createElement(BulkOrderPage, { tradeToken, addToCart, goTradeDashboard }), view === "visit-recap" && visitRecapToken && /* @__PURE__ */ React.createElement(VisitRecapPage, { token: visitRecapToken, onSkuClick: goSkuDetail }), view === "reset-password" && /* @__PURE__ */ React.createElement(ResetPasswordPage, { goHome, openLogin: () => {
    setAuthModalMode("login");
    setShowAuthModal(true);
...
function SkuDetailView({ skuId, goBack, addToCart, cart, onSkuClick, onRequestInstall, tradeCustomer, wishlist, toggleWishlist, recentlyViewed, addRecentlyViewed, customer, customerToken, onShowAuth }) {
  ...
  if (fetchError) return /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 600, margin: "6rem auto", textAlign: "center", padding: "0 2rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "4rem", marginBottom: "1rem", color: "var(--stone-300)" } }, fetchError === "not_found" ? "404" : "Oops"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "'Cormorant Garamond', serif", fontSize: "2rem", marginBottom: "0.75rem" } }, fetchError === "not_found" ? "Product Not Found" : "Something Went Wrong"), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--stone-600)", marginBottom: "2rem", lineHeight: 1.6 } }, fetchError === "not_found" ? "This product may have been removed or the link may be incorrect." : "We had trouble loading this product. Please try again."), /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: goBack }, "Back to Shop"));
...
function WishlistPage({ wishlist, toggleWishlist, onSkuClick, goBrowse }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "wishlist-page" }, /* @__PURE__ */ React.createElement("h1", null, "Wishlist ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: "1.25rem", color: "var(--stone-600)", fontWeight: 300 } }, "(", wishlist.length, ")")), loading ? /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", padding: "4rem", color: "var(--stone-500)" } }, "Loading...") : skus.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "wishlist-empty" }, /* @__PURE__ */ React.createElement("p", null, "Your wishlist is empty"), /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: goBrowse }, "Browse Products")) : /* @__PURE__ */ React.createElement("div", { className: "sku-grid" }, skus.map((sku) => /* @__PURE__ */ React.createElement(
    SkuCard,
    {
      key: sku.sku_id,
      sku,
...
function TradeDashboard({ tradeCustomer, tradeToken, addToCart, goBrowse, setTradeCustomer, handleTradeLogout, goBulkOrder }) {
  ...
  const acceptQuote = async (quoteId) => {
    ...
    if (resp.ok) {
      alert("Quote accepted! Order has been created.");
      loadTab("quotes");
    } else {
      const d = await resp.json();
      alert(d.error || "Failed to accept quote");
    }
  };
  ...
  const changePassword = async () => {
    ...
    if (resp.ok) {
      ...
      const d = await resp.json();
      alert(d.error || "Failed to change password");
    }
  };
