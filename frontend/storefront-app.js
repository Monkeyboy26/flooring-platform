(() => {
  ...
  function AccountPage({ customer, customerToken, setCustomer, goBrowse, section, setSection, wishlist, toggleWishlist: toggleWishlist2, onSkuClick, addToCart, showToast, goHome, onLogout }) {
