(() => {
  ...
  function AccountPage({ customer, customerToken, setCustomer, goBrowse, section, setSection, wishlist, toggleWishlist: toggleWishlist2, onSkuClick, addToCart, showToast, navigate, goHome, onLogout }) {
    ...
    const renderOrderExpanded = () => /* @__PURE__ */ React.createElement("div", { className: "acct-order-expanded" }, orderDetail.order.tracking_number && /* @__PURE__ */ React.createElement("div", { style: { background: "#dbeafe", padding: "0.75rem 1rem", marginBottom: "1rem", fontSize: "0.8125rem", color: "#1e40af", borderRadius: 4 } }, "Tracking: ", orderDetail.order.shipping_carrier && /* @__PURE__ */ React.createElement("strong", null, orderDetail.order.shipping_carrier, " "), /* @__PURE__ */ React.createElement("strong", null, orderDetail.order.tracking_number), orderDetail.order.shipped_at && /* @__PURE__ */ React.createElement("span", { style: { marginLeft: "0.5rem" } }, "(Shipped ", fmtDate(orderDetail.order.shipped_at), ")")), orderDetail.order.delivery_method === "pickup" && orderDetail.fulfillment_summary && orderDetail.fulfillment_summary.total > 0 && ["confirmed", "shipped", "delivered"].includes(orderDetail.order.status) && (() => {
