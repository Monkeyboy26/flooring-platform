...
<h2>1. Overview</h2><p>This Privacy Policy explains how Roma Flooring Designs ("Roma," "we," or "us") collects, uses, and shares information when you visit this site, create an account, request a sample or quote, place an order, or otherwise interact with us. By using this site or purchasing from us, you consent to the practices described here.</p>
<h2>2. Information You Provide</h2><p>We collect information you give us directly &mdash; for example your name, email address, phone number, billing and shipping addresses, order and sample-request history, account login credentials, project details, and any messages you send us. Trade applicants may also provide business information and verification documents.</p>
<h2>3. Information Collected Automatically</h2><p>When you use the site we automatically collect certain technical and usage information, such as device and browser type, IP address, pages viewed, products and quotes you interact with, referring pages, and a cart or session identifier, using cookies and similar technologies.</p>
<h2>4. Payment Information</h2><p>Payments are processed by our third-party payment providers (such as Stripe and Klarna). Full payment card numbers are handled by those providers and are not stored on our servers.</p>
<h2>5. How We Use Information</h2><p>We use information to process, fulfill, and deliver orders and samples; create and manage accounts; provide customer support; send transactional messages such as order, account, and shipping notifications; operate, secure, and improve our services; measure engagement; prevent fraud; and comply with legal obligations.</p>
<h2>6. How We Share Information</h2><p>We share information only as needed to run the business &mdash; for example with service providers that host our systems, process payments, deliver shipments, fulfill orders, send email or text messages, and provide analytics, each permitted to use the information only to perform services for us. We do not sell your personal information.</p>
<h2>7. Text Messaging (SMS)</h2><p>If you provide your mobile phone number and consent, we may send you service and review-request text messages, such as order and delivery updates and a post-purchase invitation to rate your experience. You consent by checking the SMS box when you place an order or request a quote on this site, or by telling a Roma team member; consent is not a condition of any purchase. Message frequency varies, and message and data rates may apply. Reply STOP to opt out at any time, or HELP for help. <strong>We do not sell or share your mobile phone number or your SMS opt-in and consent information with any third parties or affiliates for their own marketing or promotional purposes.</strong> Opt-in data is used only to send the messages you requested and is shared only with the messaging service providers that help us deliver them.</p>
<h2>8. Cookies &amp; Your Choices</h2><p>A cookie notice lets you accept or decline non-essential cookies, and you can change your choice at any time using the "Cookie preferences" link in the site footer. You may unsubscribe from marketing emails using the link in those messages; we may still send non-promotional, transactional messages about your orders and account.</p>
<h2>9. Data Retention</h2><p>We retain information for as long as needed to provide our services, maintain your account and order records, resolve disputes, and comply with our legal, tax, and accounting obligations.</p>
<h2>10. Data Security</h2><p>We use reasonable, industry-standard safeguards, including encryption in transit, designed to protect information under our control. No method of transmission or storage is completely secure.</p>
<h2>11. Your Rights</h2><p>You may access or update your account information by signing in, or request access, correction, or deletion of your personal information by contacting us. California residents have additional rights under the CCPA; we do not sell personal information.</p>
<h2>12. Children's Privacy</h2><p>This site is intended for adults and is not directed to children. We do not knowingly collect personal information from children under 16.</p>
<h2>13. Changes to This Policy</h2><p>We may update this Privacy Policy from time to time. Changes are effective when the updated policy is posted.</p>
<h2>14. Contact</h2><p>Questions about your privacy or this policy? Contact Roma Flooring Designs at (714) 999-0009 or Sales@romaflooringdesigns.com, 1440 S. State College Blvd #6M, Anaheim, CA 92806.</p>`
    },
    terms: {
...
<h2>5. Inspection, Returns &amp; Claims</h2><p>You are responsible for inspecting all materials before installation; installation constitutes final acceptance. Natural materials vary in color, veining, and finish, which is normal and not a defect. Damage, shortage, and incorrect-product claims must be reported within 48 hours of delivery with photos (concealed damage within 5 days). Breakage of up to 5% of a tile, stone, or mosaic order is within industry tolerance and is not eligible for claim; you are responsible for ordering adequate overage &mdash; an industry-standard 10&ndash;15% is recommended, and at least 15% for diagonal, herringbone, or other pattern installations. Returns, exchanges, and cancellations are limited as described at the point of sale and may be subject to restocking and freight charges.</p>
