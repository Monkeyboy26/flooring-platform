...
${q.sidemark ? `<span style="color:var(--muted);">Sidemark</span><span style="text-align:right;">${escDoc(q.sidemark)}</span>` : ''}
${q.rep_name ? `<span style="color:var(--muted);">Prepared by</span><span style="text-align:right;">${escDoc(q.rep_name)}</span>` : ''}
</div>
