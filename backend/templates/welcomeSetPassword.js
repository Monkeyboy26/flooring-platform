...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border:1px solid #e7e5e4;">
  <tr><td style="padding:40px 40px 20px;text-align:center;border-bottom:1px solid #e7e5e4;">
    ...
    <p style="font-size:12px;text-transform:uppercase;letter-spacing:0.1em;color:#78716c;margin:0;">Welcome</p>
  </td></tr>
  <tr><td style="padding:40px;">
    ...
    <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-size:24px;font-weight:400;color:#1c1917;margin:0 0 16px;text-align:center;">Welcome to Roma Flooring Designs</h2>
    <p style="color:#57534e;line-height:1.6;margin:0 0 16px;">Hi ${name}, your account has been created by our team. Set your password to access your order history, track shipments, and reorder with ease.</p>
    <div style="text-align:center;margin:32px 0;">
      <a href="${esc(resetUrl)}" style="display:inline-block;background:#b8960c;color:#fff;text-decoration:none;padding:14px 40px;font-size:14px;font-weight:500;text-transform:uppercase;letter-spacing:0.05em;">Set Your Password</a>
    </div>
    <p style="color:#78716c;font-size:13px;line-height:1.6;margin:0 0 16px;">This link expires in 7 days. You can also visit our website and use "Forgot Password" at any time.</p>
