...
export function generateSubscriptionDeactivatedHTML(customer) {
  return `<!DOCTYPE html>
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border:1px solid #e7e5e4;">
  ...
  <tr><td style="padding:40px;">
    <h2 style="font-family:'Cormorant Garamond',Georgia,serif;font-size:24px;font-weight:400;color:#78716c;margin:0 0 16px;">Membership Deactivated</h2>
    <p style="color:#57534e;line-height:1.6;margin:0 0 16px;">Dear ${esc(customer.contact_name)},</p>
    <p style="color:#57534e;line-height:1.6;margin:0 0 16px;">Your trade membership for <strong>${esc(customer.company_name)}</strong> has been deactivated after the 30-day grace period expired without a successful payment.</p>
    <p style="color:#57534e;line-height:1.6;margin:0 0 16px;">Your trade account remains on file. If you wish to rejoin the program in the future, you are welcome to reapply through our website.</p>
    <p style="color:#57534e;line-height:1.6;margin:0;">Thank you for your past partnership with Roma Flooring Designs.</p>
  </td></tr>
